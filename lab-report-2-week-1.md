...
Because I used the TA log in, I created a directory to work in with the command `mkdir ronasDirectory`. I then accessed this directory using `cd ronasDirectory`. 

## Trying Some Commands 
Once logged in, you can try out a few commands.
